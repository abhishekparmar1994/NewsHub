...
export class NewsItem extends Component {
    ...
    render() {
        ...
        let formattedDate = this.formatDate(date); // Format date as "19th Jan 1994 at 10:30 AM"
        return (
            <div className="my-3">
                <div className="card"><span className="position-absolute top-0 start-50 translate-middle badge rounded-pill bg-danger">{source}<span className="visually-hidden">unread messages</span></span>
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text"><small className="text-body-secondary">By : {author} on {formattedDate}</small></p>
